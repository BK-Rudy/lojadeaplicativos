...
public abstract class Aplicativo {
	...
	public abstract float calcularOferta() throws AnoLancamentoNaoPreenchidoException, FormatoNaoPreenchidoException, CategoriaAppNaoPreenchidaException;
	
	public String getAplicativo() throws AnoLancamentoNaoPreenchidoException, CategoriaAppNaoPreenchidaException, FormatoNaoPreenchidoException {
