...
<body>
	...
	<div class="container">
		<form action="/livro/incluir" method="post">
			...
			<div class="form-group">
				<label>Nome do(a) autor(a):</label> <input type="text"
					name="autor" value="Frank Herbert" class="form-control">
			</div>
			...
			<div class="form-group">
				<label>Gênero:</label> <input type="text"
					name="genero" value="Ficção científica" class="form-control">
			</div>
